document.querySelectorAll('[data-fold-lab]').forEach((lab) => {
  ...
  const update = () => {
    ...
    fields.decoderTitle.textContent = partial ? 'A12 + inverter' : '74LS154';
    fields.decoderDetail.textContent = partial ? 'ใช้ A12 + inverter เลือก 2 ชิป' : 'decode A15–A12 ครบ 4 บิต';
